...
/**
 * _strlen_recursion - a function to obtain the length of a string s
 ...
 * @s: an input string
 * Return: 1 if a string palindrome or 0 in otherwise
 */
...
/**
 * helper_panlindrome - a function with a reversed string
 * @s: an input string
 * @len: the length of a string s
