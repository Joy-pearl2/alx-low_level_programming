 ...
 * @str: a pointer to the string to slipt
 * Return: NULL if memory allocation fails or if str 
 * is NULL or empty (""), otherwise return a 
 * pointer to the array of words terminated by a NULL
 */
