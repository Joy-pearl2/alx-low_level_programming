 ...
 *
 * Description: Copy s1 followed by the first n bytes
 * of s2 into dynamically
 * allocated memory, and append a terminating null-byte.
 *
 * If n is greater than
 * or equal to the length of the string s2,
 * use only the bytes from s2 up to
